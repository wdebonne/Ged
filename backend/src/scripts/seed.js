...
// par le script CLI (après confirmation/--force) et par server.js au premier démarrage.
export const seedDatabase = async () => {
  ...
  await Settings.insertMany([
    ...
    { key: 'app_version', value: 'v3.15.0', category: 'appearance', description: 'Version de l\'application' },
...
// Exécution en CLI uniquement (node src/scripts/seed.js [--force])
