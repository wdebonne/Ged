  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="text-center">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Connexion à OneDrive</h1>
        <p className="text-gray-600 dark:text-gray-400">Authentification en cours...</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">Cette fenêtre se fermera automatiquement.</p>
      </div>
    </div>
  );
}
