...
export const mailsAPI = {
  ...
  bulkAction: (data) => api.post('/mails/bulk', data),
  addComment: (id, data) => api.post(`/mails/${id}/comments`, data),
  deleteComment: (id, commentId) => api.delete(`/mails/${id}/comments/${commentId}`),
